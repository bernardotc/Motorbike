...
public class BasicParticle  {
	...
	public void draw(Graphics2D g) {
		...
		g.fillOval(x - SCREEN_RADIUS, y - SCREEN_RADIUS, 2 * SCREEN_RADIUS, 2 * SCREEN_RADIUS);
                ...
                int x2 = x + BasicPhysicsEngineUsingBox2D.convertWorldXtoScreenX((float) (body.m_fixtureList.m_shape.m_radius * Math.cos(body.getAngle())));
                int y2 = y + BasicPhysicsEngineUsingBox2D.convertWorldXtoScreenX((float) (body.m_fixtureList.m_shape.m_radius *Math.sin(body.getAngle())));
